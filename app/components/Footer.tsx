export const Footer = () => (
  <footer className="bg-gray-800 text-white w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-7xl mx-auto">
        ...
        <div>
          ...
          <p className="text-gray-400">
            Somos expertos en electricidad y aire acondicionado, ofreciendo soluciones profesionales con un enfoque en calidad, seguridad y eficiencia.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="/privacy-policy" className="hover:underline text-gray-400">Política de Privacidad</a>
            </li>
          </ul>
        </div>
          ...
          <ul className="flex space-x-4">
            ...
            <li>
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <svg className="h-6 w-6 fill-current text-gray-400 hover:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <p className="text-gray-400">Email: contacto@electricidadprofesional.com</p>
    ...
    <div className="bg-gray-900 text-gray-500 text-center py-4">
      &copy; {new Date().getFullYear()} Electricidad Profesional. Todos los derechos reservados.
    </div>
  </footer>
);
